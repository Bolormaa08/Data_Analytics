...
heart_data <- read.csv("C:/Users/35387/OneDrive - National College of Ireland/NCI data analyst/DMML/PROJECT/DMML project 1/Heart_Disease_Mortality_Data_Among_US_Adults__35___by_State_Territory_and_County.csv", header = TRUE, stringsAsFactors = T)
...
# Columns to encode
cols_to_encode <- c( "Stratification2","Classs","Topic","Data_Value_Type","Class ","Topic")
...
print(vif_results)
#Data_Value   LocationID   Stratification2White 
#1.016057      1.014961             1.002410
